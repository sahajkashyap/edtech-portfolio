...
SELFTEST = [
    ...
    (41, "want", False, "before it is taught as a heart word"),
    ...
    (12, "so", False, "same"),
    (22, "he", False, "open syllable, and not yet a heart word"),
    (23, "he", True, "taught as a heart word at 23, so exempt from here"),
    ...
    (53, "taste", False, "same"),
    (28, "was", False, "irregular vowel and not yet taught"),
    (29, "was", True, "taught as a heart word at 29"),
    (1,  "the", True, "the very first heart word"),
    (23, "she", True, "arrives with he, so a girl can carry a pronoun too"),
    (22, "she", False, "but not the lesson before"),
    (28, "we", True, "arrives when w is taught"),
    (41, "son", False, "o saying /u/"),
    (41, "put", False, "u saying /oo/"),
    (41, "want", False, "a saying /o/ after w, before it is a heart word"),
